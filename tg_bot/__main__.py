...
TECHNO_IMG = "
IMPORTED = {}https://telegra.ph/file/f1a2acaa9afab2d3193ae.jpg"
MIGRATEABLE = []
HELPABLE = {}
STATS = []
USER_INFO = []
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/arminarlert898")],
                                                                                   [InlineKeyboardButton(text="ADD Pain bot OFFICIAL TO YOUR GROUP",
                                                                       url="t.me/{}?startgroup=true".format(bot.username)),
                                                                                   InlineKeyboardButton(text="Source Code",
                                                                       url="https://github.com/Ayanprodev/Pain bot")
                                                                                 ]]))
